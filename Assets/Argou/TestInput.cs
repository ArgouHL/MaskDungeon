...
//     version 1.17.0
//     from Assets/Argou/TestInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Argou/TestInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @TestInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""TestInputs"",
            ""id"": ""8ddce0a1-a2cc-4901-b3e8-c1b9fbc88bc1"",
            ""actions"": [
                {
                    ""name"": ""A"",
                    ""type"": ""Button"",
                    ""id"": ""ba876784-b49e-4372-8e05-c272396ee578"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""e4bd8c88-a357-4e71-8a3f-51a91f30aec9"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_TestInputs_A = m_TestInputs.FindAction("A", throwIfNotFound: true);
    }

    ~@TestInput()
    {
        UnityEngine.Debug.Assert(!m_TestInputs.enabled, "This will cause a leak and performance issues, TestInput.TestInputs.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_TestInputs_A;
    /// <summary>
    ...
    public struct TestInputsActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "TestInputs/A".
        /// </summary>
        public InputAction @A => m_Wrapper.m_TestInputs_A;
        /// <summary>
